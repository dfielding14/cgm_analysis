...
line_colors = ['k', "#003366", "#003300", "#3333cc", "#339900", "#66a61e"]
...
HSE_halo = HSE(2.0,0.1)                                              #    f_cs_HSE = 2.0, f_cgm=0.1):
HSE_turb_halo = HSE_turb(2.0,0.1,0.5)                                #    f_cs_HSE_turb = 2.0, f_cgm=0.1, Mach=0.5):
HSE_rot_halo = HSE_rot(2.0,0.1,0.05)                                 #    f_cs_HSE_rot = 2.0, f_cgm=0.1, lam=0.05):
cooling_flow_halo = cooling_flow(1.0,-4.0*Msun/yr)                   #    f_cs_CF = 2.0, Mdot = -3.0 * Msun/yr):
...
ax.plot(radii/(rvir*kpc), HSE_halo.T(radii),                                color=line_colors[0], lw=4, label='HSE')
ax.plot(radii/(rvir*kpc), cooling_flow_halo.T(radii), dashes=[1,2],         color=line_colors[4], lw=3.5, label='Cooling Flow'),
ax.plot(radii/(rvir*kpc), HSE_turb_halo.T(radii),     dashes=[4,2],         color=line_colors[1], lw=3.0, label='HSE w/'+r'$\mathcal{M}=0.5$'+' turb.')
ax.plot(radii/(rvir*kpc), HSE_rot_halo.T(radii),      dashes=[4,2,1,2],     color=line_colors[2], lw=2.5, label='HSE w/ rot. '+r'$\lambda=0.05$')
ax.plot(radii/(rvir*kpc), precipitate_halo.T(radii),  dashes=[4,2,1,2,1,2], color=line_colors[3], lw=2, label='HSE w/ ' + r'$\frac{t_{\rm cool}}{t_{\rm ff}} = 10$'+' precip.')
...
ax.plot(radii/(rvir*kpc), HSE_halo.n(radii),                                color=line_colors[0], lw=4, label='HSE')
ax.plot(radii/(rvir*kpc), cooling_flow_halo.n(radii), dashes=[1,2],         color=line_colors[4], lw=3.5, label='Cooling Flow'),
ax.plot(radii/(rvir*kpc), HSE_turb_halo.n(radii),     dashes=[4,2],         color=line_colors[1], lw=3.0, label='HSE w/'+r'$\mathcal{M}=0.5$'+' turb.')
ax.plot(radii/(rvir*kpc), HSE_rot_halo.n(radii),      dashes=[4,2,1,2],     color=line_colors[2], lw=2.5, label='HSE w/ rot. '+r'$\lambda=0.05$')
ax.plot(radii/(rvir*kpc), precipitate_halo.n(radii),  dashes=[4,2,1,2,1,2], color=line_colors[3], lw=2, label='HSE w/ ' + r'$\frac{t_{\rm cool}}{t_{\rm ff}} = 10$'+' precip.')
cb = fig.colorbar(plot)
cb.set_label(r'Volume Fraction',rotation=270,fontsize=12,labelpad=15)
cb.ax.minorticks_off()
...
ax.plot(radii/(rvir*kpc), HSE_halo.P(radii),                                color=line_colors[0], lw=4, label='HSE')
ax.plot(radii/(rvir*kpc), cooling_flow_halo.P(radii), dashes=[1,2],         color=line_colors[4], lw=3.5, label='Cooling Flow'),
ax.plot(radii/(rvir*kpc), HSE_turb_halo.P(radii),     dashes=[4,2],         color=line_colors[1], lw=3.0, label='HSE w/'+r'$\mathcal{M}=0.5$'+' turb.')
ax.plot(radii/(rvir*kpc), HSE_rot_halo.P(radii),      dashes=[4,2,1,2],     color=line_colors[2], lw=2.5, label='HSE w/ rot. '+r'$\lambda=0.05$')
ax.plot(radii/(rvir*kpc), precipitate_halo.P(radii),  dashes=[4,2,1,2,1,2], color=line_colors[3], lw=2, label='HSE w/ ' + r'$\frac{t_{\rm cool}}{t_{\rm ff}} = 10$'+' precip.')
cb = fig.colorbar(plot)
cb.set_label(r'Volume Fraction',rotation=270,fontsize=12,labelpad=15)
cb.ax.minorticks_off()
